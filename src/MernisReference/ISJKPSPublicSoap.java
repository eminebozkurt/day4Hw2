...
public class ISJKPSPublicSoap
{
    ...
    public ISJKPSPublicSoap(){}

    public ISJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ISJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ISJExtendedSoapSerializationEnvelope envelope= new ISJExtendedSoapSerializationEnvelope(ISJExtendedSoapSerializationEnvelope.VER11);
