...
public class ISJExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ISJDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ISJStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ISJDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ISJDateTimeConverter dateTimeConverter = new ISJStandardDateTimeConverter();

    public ISJExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ISJExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ISJMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ISJHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ISJExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ISJHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
